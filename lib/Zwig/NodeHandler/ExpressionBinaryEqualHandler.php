...
/**
 * Compiles a node that compares two values.
 * @see http://twig.sensiolabs.org/doc/templates.html#comparisons
 */
class ExpressionBinaryEqualHandler extends AbstractExpressionBinaryHandler
{
    const TWIG_NODE_CLASS_NAME = 'Twig_Node_Expression_Binary_Equal';
