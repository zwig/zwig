...
/**
 * Compiles a node that adds two values.
 * @see http://twig.sensiolabs.org/doc/templates.html#math
 */
class ExpressionBinaryAddHandler extends AbstractHandler
{
    const TWIG_NODE_CLASS_NAME = 'Twig_Node_Expression_Binary_Add';
    ...
    {
        return new Segment('operators.add(%s, %s)', [
